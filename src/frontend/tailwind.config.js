  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'status-not-started-foreground': "hsl(var(--status-not-started-foreground))",
        'status-marked-review': "hsl(var(--status-marked-review))",
        'status-marked-review-foreground': "hsl(var(--status-marked-review-foreground))",
        'status-scheduled': "hsl(var(--status-scheduled))",
        'status-live': "hsl(var(--status-live))",
        'status-ended': "hsl(var(--status-ended))",
      },
      borderRadius: {
        lg: "var(--radius)",
